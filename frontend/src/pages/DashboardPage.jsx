...
import { BookOpen, Award, TrendingUp, Play, Loader2, KeyRound, Eye, EyeOff, User, Mail } from 'lucide-react'
    ...
    <div className="min-h-screen bg-gray-50">
      <div className="bg-blue-800 text-white py-10">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h1 className="font-heading font-bold text-3xl">Welcome back, {user?.full_name?.split(' ')[0]}! 👋</h1>
              ...
              <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-5">
                {enrollments.map((enrollment) => (
                  <div key={enrollment.id} className="border border-gray-200 rounded-xl overflow-hidden hover:shadow-md transition-shadow">
                    ...
                    <div className="p-4">
                      <h3 className="font-semibold text-gray-800 text-sm line-clamp-2 mb-3">{enrollment.course_title || 'Course'}</h3>
                      <div className="mb-2">
                        ...
                        <div className="w-full bg-gray-200 rounded-full h-1.5">
                          <div className="bg-blue-600 h-1.5 rounded-full transition-all" style={{ width: `${enrollment.progress}%` }} />
                        </div>
                      </div>
                      {enrollment.is_completed
                        ? <span className="badge bg-green-100 text-green-700 w-full justify-center mt-2">✅ Completed</span>
              ...
              <form onSubmit={handlePasswordChange} className="space-y-4">
                ...
                <div>
                  ...
                  {passwords.confirm_password && (
                    <p className={`text-xs mt-1 ${passwords.new_password === passwords.confirm_password ? 'text-green-600' : 'text-red-500'}`}>
